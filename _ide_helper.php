...
namespace {
	...
	class Accordion extends \Bootstrapper\Accordion{
	}
	...
	class Asset extends \Slushie\LaravelAssetic\Facades\AssetFacade{
		 ...
		 */
		 public static function __construct(){
			//Method inherited from \Slushie\LaravelAssetic\Asset
			 \Slushie\LaravelAssetic\Asset::__construct();
		 }
		 ...
		 */
		 public static function __get($name){
			//Method inherited from \Slushie\LaravelAssetic\Asset
			return \Slushie\LaravelAssetic\Asset::__get($name);
		 }
